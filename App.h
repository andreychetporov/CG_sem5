...
private:
	...
	ComPtr<ID3D12Resource> billboardTexture;
	ComPtr<ID3D12Resource> billboardTextureUpload;
	ComPtr<ID3D12DescriptorHeap> billboardSrvHeap;
	ComPtr<ID3D12DescriptorHeap> billboardCbvSrvHeap;
	ComPtr<ID3D12Resource> billboardConstantBuffer;
